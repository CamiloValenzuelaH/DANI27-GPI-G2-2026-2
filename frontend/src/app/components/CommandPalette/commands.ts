...
export const COMMANDS: Command[] = [
  ...
  },
  {
    ...
    shortcut: '⇧S',
    action: () => {
      console.log('Search controls triggered')
    },
    requiredRoles: ['admin', 'manager', 'auditor', 'employee'],
  },
...
export const COMMAND_TRANSLATIONS = {
  ...
  es: {
    ...
    'nav-understand.title': 'Ir a Analisis de brechas',
    'nav-understand.desc': 'Navegar a la página de Analisis de brechas',
    'nav-evidence.title': 'Ir a..',
